    ...
    <section className="py-16 px-4 bg-[#3b73ed] text-white overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl pt-6 font-bold leading-snug font-satoshi text-white">
            More Than a Notebook. It's a Knowledge Engine.
            <br />
          </h2>
          <p className="text-white/90 font-medium mt-4 font-inter max-w-xl mx-auto py-6">
            BrainBoard is for anyone overwhelmed by information. We help you
            connect the dots between your ideas, links, and notes to fuel real
            progress.
          </p>
        </div>
