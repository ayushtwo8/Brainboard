    ...
    <>
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:bg-[#3B73ED] lg:pt-6 lg:shadow-lg lg:shadow-black/20  rounded-r-xl border-r-4  border-black">
        <div className="flex items-center justify-center px-6">
          <div className="bg-[#fafcff] p-1.5 rounded-full" />
          <h1 className="ml-2 text-xl font-bold font-grotesk text-white">
            BrainBoard
          </h1>
        </div>
        ...
        <div className="px-4 mt-6 mb-6">
          <button
            onClick={() =>
              window.open("https://github.com/ayushtwo8/brainboard", "_blank")
            }
        ...
        <div className="fixed inset-0 z-50 bg-black/50">
          <div className="fixed inset-y-0 left-0 w-64 bg-white p-6">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-bold font-grotesk text-[#3b73ed]">
                BrainBoard
              </h1>
              <Button
                onClick={toggleMobileMenu}
            ...
            <nav className="mt-8 space-y-2">
              ...
              <button
                onClick={() => {
                  window.open(
                    "https://github.com/ayushtwo/brainboard",
                    "_blank"
                  );
                  setIsMobileMenuOpen(false);
                }}
